...
//fix long rows [BEGIN]
	...
	$orow[ltname]=trim( StrCutLen( $ltname, 14 )); if ( strlen( $orow[ltname] )==strlen( $ltname )) $ltname=="";
...
//states [END]
	...
	echo "
	<td $rjust><b><a href='../".$hFrm['0520']."?cow_id=".$r."&ret0=-1'>".$cownum_div.$cownum.$cownum_div1."</a></b></td>
	<td title='$cownick'><a href='../".$hFrm['0520']."?cow_id=".$r."&ret0=-1'>".$orow[cownick]."</a>&nbsp;</td>
